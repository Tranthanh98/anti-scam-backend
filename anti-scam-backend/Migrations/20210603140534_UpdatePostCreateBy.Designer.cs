...
namespace anti_scam_backend.Migrations
{
    ...
    [Migration("20210603140534_UpdatePostCreateBy")]
    partial class UpdatePostCreateBy
    {
            ...
            modelBuilder.Entity("anti_scam_backend.Domain.Entities.RoleAdmin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("44f6e86e-e8ac-405b-b2c0-dd8b9423cf47"),
                            RoldId = 1
                        },
                        new
                        {
                        ...
                        new
                        {
                            UserId = new Guid("87ec2679-f9fc-414c-805f-0812ae0223d2"),
                            RoldId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("anti_scam_backend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("44f6e86e-e8ac-405b-b2c0-dd8b9423cf47"),
                            CodeValidate = "123456",
                            Email = "Trantienthanh2412@gmail.com",
                            IsActive = true,
                            IsAdmin = true,
                            JoinedDate = new DateTimeOffset(new DateTime(2021, 6, 3, 14, 5, 33, 820, DateTimeKind.Unspecified).AddTicks(7873), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("87ec2679-f9fc-414c-805f-0812ae0223d2"),
                            CodeValidate = "123456",
                            Email = "antiscam.contact@gmail.comm",
                            IsActive = true,
                            IsAdmin = true,
                            JoinedDate = new DateTimeOffset(new DateTime(2021, 6, 3, 14, 5, 33, 821, DateTimeKind.Unspecified).AddTicks(1221), new TimeSpan(0, 0, 0, 0, 0)),
                            Password = "AQAAAAEAACcQAAAAEBAPlUdwTj0sci7gABciifU0cXR+sD/GUUtK99iAzlEcmqzuCE4Z8TflzHN9Nv6+KQ==",
                            Salt = "pscznq",
                            UserName = "Admin"
                        });
